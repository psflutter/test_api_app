...
import 'package:home_services/app/modules/bookings/views/bookings_list_view.dart';
          ...
          return GestureDetector(
            onTap: () {
              ...
              if(a==0){
                  Navigator.push(
               context,
                   MaterialPageRoute(builder: (context) =>  BookingsListView()),
              );
              }else{
                _changeIndex(index);}
              ...
              child: Column(
               // mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: <Widget>[
                  ...
                  Text(label,
                  style: TextStyle(color: widget.currentIndex == index ? color : Colors.black),),
